...
SRC_TRANS_DECIMAL_PATH = $(SRC_TRANS_PATH)decimal/
...
SRC_MISC_FILES = ft_itoa_l.c ft_bzero.c ft_itoa.c create_width_string.c number_of_signs.c ft_putchar.c ft_strlen.c ft_putstr.c ft_atoi.c ft_strncmp.c skip_letters.c skip_numbers.c
...
SRC_TRANS_FILES = transform.c

SRC_TRANS_DECIMAL_FILES = choose_length_decimal.c transform_d.c transform_d_hh.c transform_d_h.c transform_d_l.c transform_d_ll.c
...
SRC_TRANS_DECIMAL_CORE = $(addprefix $(SRC_TRANS_DECIMAL_PATH), $(SRC_TRANS_DECIMAL_FILES))
...
OBJ_TRANS_DECIMAL_CORE = $(addprefix $(OBJ_PATH), $(SRC_TRANS_DECIMAL_FILES:.c=.o))

OBJECTS = $(OBJ_TRANS_DECIMAL_CORE) $(OBJ_BUFFER_CORE) $(OBJ_MAIN_CORE) $(OBJ_INIT_CORE) $(OBJ_PARSE_CORE) $(OBJ_PARSE_CORE_LENGTH) $(OBJ_PARSE_CORE_TYPE) $(OBJ_MISC_CORE) $(OBJ_SAVE_CORE) $(OBJ_SAVE_CORE_LENGTH) $(OBJ_SAVE_CORE_TYPE) $(OBJ_TEST_CORE) $(OBJ_TRANS_CORE) $(OBJ_PRINT_CORE)
...
objects/%.o: $(SRC_TRANS_DECIMAL_PATH)%.c | objects
	@($(GCC) $(GCC_FLAGS) $(GCC_INCLUDE) -c $< -o $@)
	@(echo $< "->" $@)