...
GCC_INCLUDE = -I $(INC_PATH) -I $(INC_LIBFT)
GCC_LIBCON = -L $(INC_LIBFT)
...
SRC_MISC_FILES = skip_letters.c skip_numbers.c
...
SRC_SAVE_CORE_TYPE = $(addprefix $(SRC_SAVE_TYPE_PATH), $(SRC_SAVE_TYPE_FILE))
...
OBH_SAVE_CORE_TYPE = $(addprefix $(OBJ_PATH), $(SRC_SAVE_TYPE_FILES:.c=.o))

OBJECTS = $(OBJ_MAIN_CORE) $(OBJ_INIT_CORE) $(OBJ_PARSE_CORE) $(OBJ_PARSE_CORE_LENGTH) $(OBJ_PARSE_CORE_TYPE) $(OBJ_MISC_CORE) $(OBJ_SAVE_CORE) $(OBJ_SAVE_CORE_LENGTH) $(OBJ_SAVE_CORE_TYPE)
